...
public class MainSearchMSED {
    public static void main(String[] args) throws IOException {
        ...
        reps.add(context.getData(sheep).getVecSum());
        reps.add(context.getData(bear).getVecSum());
        ...
        ConcurrentOrderedList<Integer, Double> results = desc.knnSearch(query, 200, 200);
